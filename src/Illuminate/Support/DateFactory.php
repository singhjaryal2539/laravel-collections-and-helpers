 ...
 *
 * @method \SinghJaryal\Illuminate\Support\Carbon create($year = 0, $month = 1, $day = 1, $hour = 0, $minute = 0, $second = 0, $tz = null)
 * @method \SinghJaryal\Illuminate\Support\Carbon createFromDate($year = null, $month = null, $day = null, $tz = null)
 * @method \SinghJaryal\Illuminate\Support\Carbon|false createFromFormat($format, $time, $tz = null)
 * @method \SinghJaryal\Illuminate\Support\Carbon createFromTime($hour = 0, $minute = 0, $second = 0, $tz = null)
 * @method \SinghJaryal\Illuminate\Support\Carbon createFromTimeString($time, $tz = null)
 * @method \SinghJaryal\Illuminate\Support\Carbon createFromTimestamp($timestamp, $tz = null)
 * @method \SinghJaryal\Illuminate\Support\Carbon createFromTimestampMs($timestamp, $tz = null)
 * @method \SinghJaryal\Illuminate\Support\Carbon createFromTimestampUTC($timestamp)
 * @method \SinghJaryal\Illuminate\Support\Carbon createMidnightDate($year = null, $month = null, $day = null, $tz = null)
 * @method \SinghJaryal\Illuminate\Support\Carbon|false createSafe($year = null, $month = null, $day = null, $hour = null, $minute = null, $second = null, $tz = null)
 * @method \SinghJaryal\Illuminate\Support\Carbon disableHumanDiffOption($humanDiffOption)
 * @method \SinghJaryal\Illuminate\Support\Carbon enableHumanDiffOption($humanDiffOption)
 * @method mixed executeWithLocale($locale, $func)
 * @method \SinghJaryal\Illuminate\Support\Carbon fromSerialized($value)
 * @method array getAvailableLocales()
 * @method array getDays()
 * @method int getHumanDiffOptions()
 * @method array getIsoUnits()
 * @method \SinghJaryal\Illuminate\Support\Carbon getLastErrors()
 * @method string getLocale()
 * @method int getMidDayAt()
 * @method \SinghJaryal\Illuminate\Support\Carbon getTestNow()
 ...
 * @method \SinghJaryal\Illuminate\Support\Carbon instance($date)
 * @method bool isImmutable()
 * @method bool isModifiableUnit($unit)
 * @method \SinghJaryal\Illuminate\Support\Carbon isMutable()
 ...
 * @method \SinghJaryal\Illuminate\Support\Carbon|null make($var)
 * @method \SinghJaryal\Illuminate\Support\Carbon maxValue()
 * @method \SinghJaryal\Illuminate\Support\Carbon minValue()
 * @method void mixin($mixin)
 * @method \SinghJaryal\Illuminate\Support\Carbon now($tz = null)
 * @method \SinghJaryal\Illuminate\Support\Carbon parse($time = null, $tz = null)
 ...
 * @method \SinghJaryal\Illuminate\Support\Carbon setHumanDiffOptions($humanDiffOptions)
 ...
 * @method \SinghJaryal\Illuminate\Support\Carbon setUtf8($utf8)
 ...
 * @method \SinghJaryal\Illuminate\Support\Carbon today($tz = null)
 * @method \SinghJaryal\Illuminate\Support\Carbon tomorrow($tz = null)
 * @method void useMonthsOverflow($monthsOverflow = true)
 * @method \SinghJaryal\Illuminate\Support\Carbon useStrictMode($strictModeEnabled = true)
 * @method void useYearsOverflow($yearsOverflow = true)
 * @method \SinghJaryal\Illuminate\Support\Carbon yesterday($tz = null)
 */
class DateFactory
{
    /**
